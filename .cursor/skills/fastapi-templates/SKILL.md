...
- Apply the patterns in this skill directly in the target repository; optional deep dives can be added as project-specific `reference.md` files next to this `SKILL.md` if needed.
